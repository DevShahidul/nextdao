...
export const BidingSlide = ({
  ...
  const countdownClock = `${Math.trunc((countdown / 60 / 60) % 24)}h ${String(
    Math.trunc((countdown / 60) % 60)
  ).padStart(2, 0)}m ${Math.trunc(countdown % 60)}s`;
    ...
    <div>
      {isFirstBid ? (
        <div className={styles.slide_item}>
          ...
          <div
            className={`d-flex align-center justify-center ${styles.help_row}`}
          >
            ...
            <form>
              <div className={styles.place_bid_row}>
                ...
                <InputField
                  id="bid_field"
                  name="bid_field"
                  placeholder="71.56 or more"
                  handleChange={onHandleChange}
                  value={bidField}
                  type="text"
                />
                <button
                  className={`btn ${styles.btn_place_bid}`}
          ...
          <div className={styles.bid_items_wrap}>
            ...
            <a
              href="#"
              onClick={handleIsHistory}
              className={styles.view_all_bids_link}
            >
              View all bids
            </a>
          </div>
        ...
        <div className={styles.slide_item}>
          ...
          <div className={styles.bid_winner_info_wrap}>
            <ul className={styles.winner_info_items_list}>
              <li
                className={`d-flex align-center justify-center ${styles.winner_info_item}`}
              >
                <BirthCake
                  className={`${styles.info_icon} ${styles.birth_cake}`}
                />
              ...
              >
                <LoveIcon
                  className={`${styles.info_icon} ${styles.love_icon}`}
                />
            ...
            <div className={`d-flex justify-center ${styles.btn_row}`}>
              <button
                className={`btn d-flex align-center ${styles.winner_info_btn} ${styles.btn_bid_history}`}
                onClick={handleIsHistory}
              >
              ...
              <button
                className={`btn d-flex align-center ${styles.winner_info_btn} ${styles.btn_etherscan}`}
              >
