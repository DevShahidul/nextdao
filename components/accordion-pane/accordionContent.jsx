export const accordionContents = [
  ...
  },
  {
    ...
    content: [
      {
        type: 'p',
        texts: ["The Noun Seeder contract is used to determine Noun traits during the minting process. The seeder contract can be replaced to allow for future trait generation algorithm upgrades. Additionally, it can be locked by the Nouns DAO to prevent any future updates. Currently, Noun traits are determined using pseudo-random number generation:"]
      },
      {
        type: 'code',
        texts: ["keccak256(abi.encodePacked(blockhash(block.number - 1), nounId))"]
      },
      {
        type: 'p',
        texts: ["Trait generation is not truly random. Traits can be predicted when minting a Noun on the pending block."]
      }
    ]
  },
  {
    ...
    content: [
      {
        type: 'p', 
        texts: ["'Nounders' are the group of ten builders that initiated Nouns. Here are the Nounders:"]
      },
      {
        type: 'ul',
        texts: [
