export const accordionContents = [
    {
      title: 'Summary',
      content: {
        ul: ['Nouns artwork is in the <a> public domain. </a>',
    ...
    },
    {
      title: 'Nouns DAO',
      content: {
        p: ['Nouns DAO utilizes a fork of <a> Compound Governance and </a> is the main governing body of the Nouns ecosystem. The Nouns DAO treasury receives 100% of ETH proceeds from daily Noun auctions. Each Noun is an irrevocable member of Nouns DAO and entitled to one vote in all governance matters. Noun votes are non-transferable (if you sell your Noun the vote goes with it) but delegatable, which means you can assign your vote to someone else as long as you own your Noun.']
      }
    },
    {
      title: 'Governance ‘Slow Start’',
      content: {
        p: ['In addition to the precautions taken by Compound Governance, Nounders have given themselves a special veto right to ensure that no malicious proposals can be passed while the Noun supply is low. This veto right will only be used if an obviously harmful governance proposal has been passed, and is intended as a last resort.', 'Nounders will proveably revoke this veto right when they deem it safe to do so. This decision will be based on a healthy Noun distribution and a community that is engaged in the governance process.']
      }
    },
    {
      title: 'Noun Traits',
      content: {
        p: ['Nouns are generated randomly based Ethereum block hashes. There are no \'if\' statements or other rules governing Noun trait scarcity, which makes all Nouns equally rare. As of this writing, Nouns are made up of:'],
        ul: ['backgrounds (2)', 'bodies (30)', 'accessories (137)', 'heads (234)', 'glasses (21)'],
        p: ['You can experiment with off-chain Noun generation at the <a> Playground.</a>']
      }
    },
    {
      title: 'On-Chain artwork',
      content: {
        p: ['Nouns are stored directly on Ethereum and do not utilize pointers to other networks such as IPFS. This is possible because Noun parts are compressed and stored on-chain using a custom run-length encoding (RLE), which is a form of lossless compression.', 'The compressed parts are efficiently converted into a single base64 encoded SVG image on-chain. To accomplish this, each part is decoded into an intermediate format before being converted into a series of SVG rects using batched, on-chain string concatenation. Once the entire SVG has been generated, it is base64 encoded.']
      }
    },
    {
      title: 'Noun Seeder Contract',
      content: {
        ...
        p: ['Trait generation is not truly random. Traits can be predicted when minting a Noun on the pending block.']
      }
    },
    {
      title: 'Nounder\'s Reward',
      content: {
        p: ['\'Nounders\' are the group of ten builders that initiated Nouns. Here are the Nounders:'],
        ul: ['@cryptoseneca', '@supergremplin','@punk4156', '@eboyarts', '@punk4464', 'solimander', '@dhof', '@devcarrot', '@TimpersHD', '@lastpunk9999']
      }
    },
]