    ...
    <header className={styles.header_main}>
        <div className={`container ${styles.header_container}`}>
            <div className={`${styles.nav_row} d-flex align-center`}>
                ...
                <button className={`btn ${styles.nav_toggler} ${isExpand && styles.close} ml-auto`} onClick={() => setIsExpand(!isExpand)}>
                    <span></span>
                </button>
                <div className={`ml-auto ${styles.nav_wrap} ${isExpand && styles.expanded}`}>
